...
import pyperclip
import time
browser = webdriver.Chrome("C:/chromedr/chromedriver")#change this path to your chromedriver path
...
while(True):
    ...
    if(start == 's'):
        ...
        try:
            ...
            browser.find_element_by_xpath("//*[contains(text(), 'TAKE A TYPING TEST')]").click()
